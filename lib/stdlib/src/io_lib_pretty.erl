...
-export([intermediate/7, intermediate/8, write/1]).
...
print(Term, Col, Ll, D, Pl, M, T, RecDefFun, Enc, Str, Ord) when Col =< 0 ->
...
print_length(<<_/bitstring>> = Bin, D, Pl, T, RF, Enc, Str, Ord) ->
    ...
    case
        ...
        printable_bin0(Bin, D1, Pl, tsub(T, 6), Enc)
    of
        ...
        false ->
            case io_lib:write_binary(Bin, D, T) of
                ...
                {S, _Rest} ->
                    More = fun(T1, Dd) ->
                                   ?FUNCTION_NAME(Bin, D+Dd, Pl, T1, RF,
                                                  Enc, Str, Ord)
                           end,
