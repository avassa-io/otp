...
do_update(Fd,Info,Prev,Config) ->
    ...
    writepinfo(Fd, Info#etop_info.procinfo, modifier(Fd), HR, FieldWidths, IsTerminal, ShellMode),
    writedoubleline(Fd, FieldWidths, IsTerminal, ShellMode),
...
writepinfo(Fd,[#etop_proc_info{pid=Pid,
			       ...
			       mq=MQ}
	       |T],
           Modifier, HR, FieldWidths, IsTerminal, ShellMode) ->
    ...
    writepinfo(Fd,T,Modifier, HR, FieldWidths, IsTerminal, ShellMode);
writepinfo(_Fd,[],_,_,_,_,_) ->
    ok.
